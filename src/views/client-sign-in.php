                ...
                <div class="form_content flex--row justify--around">
                    ...
                    <div class="form1 flex--column">
                        <label class="py-2 flex--column" for="firstname">
                            Prénom
                            <input class="semiRadius" id="firstname" name="firstname" type="text" autocomplete="off" value="<?= $signData["firstname"] ?? "" ?>" required>
                        </label>
                        <label class="py-2 flex--column" for="lastname">
                            Nom
                            <input class="semiRadius" id="lastname" name="lastname" type="text" autocomplete="off" value="<?= $signData["lastname"] ?? "" ?>" required >
                        </label>
                        <label class="py-2 flex--column" for="email">
                            Adresse Mail
                            <input class="semiRadius" id="email" name="email" type="text" autocomplete="off" value="<?= $signData["email"] ?? "" ?>" required >
                        </label>
                        <label class="py-2 flex--column" for="pwd">
                            Mot de passe (doit contenir
                            <br>
                            1 chiffre et 1 caractère spécial)
                            <input class="semiRadius" id="pwd" name="pwd" type="password" autocomplete="off" value="<?= $signData["pwd"] ?? "" ?>"  required >
                        </label>
                        <label class="py-2 flex--column" for="pwd_check">
                            Confirmez votre mot de passe
                            <input class="semiRadius" id="pwd_check" name="pwd_check" type="password" autocomplete="off" value="<?= $signData["pwd_check"] ?? "" ?>"  required >
                        </label>
                        <label class="py-2 flex--column" for="phone">
                            Numero de téléphone
                            <input class="semiRadius" id="phone" name="phone"  type="tel" autocomplete="off" value="<?= $signData["phone"] ?? "" ?>" required >
                        </label>
                    </div>
                    ...
                    <div class="form1 flex--column">
                        <label class="py-2 flex--column" for="road_number">
                            Numéro de rue
                            <input class="semiRadius" type="text"  name="road_number" autocomplete="off" value="<?= $signData["road_number"] ?? "" ?>"  required>
                        </label>
                        <label class="py-2 flex--column" for="road">
                            Rue
                            <input class="semiRadius" type="text"  name="road" autocomplete="off" value="<?= $signData["road"] ?? "" ?>" required>
                        </label>
                        <label class="py-2 flex--column" for="city">
                            Ville
                            <input class="semiRadius" type="text"  name="city" autocomplete="off" value="<?= $signData["city"] ?? "" ?>"  required>
                        </label>
                        <label class="py-2 flex--column" for="zip_code">
                            Code Postale
                            <input class="semiRadius" type="text"  name="zip_code" autocomplete="off" value="<?= $signData["zip_code"] ?? "" ?>" required>
                        </label>
                        <label class="py-2 flex--column" for="country">
                            Pays
                            <input class="semiRadius" type="text"  name="country" autocomplete="off" value="<?= $signData["country"] ?? "" ?>"  required>
                        </label>
                        <label class="py-2 " class="input_date_naissance">Date de naissance:<br>
                            <label class="py-1 " for="Jour">
                                Jour
                                <input class="semiRadius" type="number"  min="1" max="31" placeholder="" name="day" autocomplete="off" value="<?= $signData["day"] ?? "" ?>"  required>
                            </label>
                            <label class="py-1" for="month">Mois
                                <select class="semiRadius" name="month" id="month-select" size="0" autocomplete="off" value="<?= $signData["month"] ?? "" ?>" required>
                            ...
                            <label class="py-2 " for="Année">
                                Année
                                <input class="semiRadius" type="number"  placeholder="2020" max="2020" min="1900" name="year" autocomplete="off" value="<?= $signData["year"] ?? "" ?>" required>
                            </label>
                        </label>
                    </div>
