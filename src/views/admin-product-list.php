...
?>
        ...
        <table class="marginTop5 flex--row justify--center text-center py-1" style="width: 100%;">
            <tr class="bg--light-grey f-white ">
                ...
                <td class="arrayCell">Catégorie</td>
                <td class="arrayCell">Prix</td>
                <td class="arrayCell">Editer</td>
            ...
            ?>
                <tr class="bg--medium-grey">
                    ...
                    <td class="arrayCell marginX1"><?= PRODUCT_CATEGORIES[ $product->getCategory() ]?></td>
                    <td class="arrayCell marginX1"><?= $product->getPrice()?> €</td>
                    <td class="arrayCell marginX1"><a href="<?= PathGenerator::generatePath( ADMIN_UPDATE_PRODUCT_ROUTE . $product->getId() ); ?>" id="suppArticle">Editer</a></td>
                    <td class="arrayCell marginX1"><a href="<?= PathGenerator::generatePath( ADMIN_DELETE_PRODUCT_ROUTE . $product->getId() ); ?>" id="suppArticle">Supprimer</a></td>
                </tr>
            <?php
                }
            ?>
